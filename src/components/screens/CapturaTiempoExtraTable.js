...
export const CapturaTiempoExtraTable = (props) => {
    ...
    useEffect(() => {
        ...
        console.log("seejecuto props.te_empleado");
      }, [props.te_empleado])

      useEffect(() => {
        console.log(props.te_empleado);
        console.log("seejecuto props");
      }, [])

    const columns = useMemo(() => COLUMNS, [])
    const data = useMemo(() => props.locals, [])
        ...
        hooks.visibleColumns.push((columns) => {
                return [
                    ...columns,
                    {
                        ...
                        Header: 'ops',
                        Cell: ({row})=>(
                            <CapturaTeButton index={{...row}} lista={props.locals} />
                        )
                    }
                ]
            })
